...
// Keys match the `term` prop used by <GlossaryTooltip>.
// Each term has translations for en/hi/mr.
...
export const getGlossaryEntry = (termKey, lang) => {
  const entry = glossary[termKey];
  if (!entry) return null;
  return entry[lang] || entry.en;
};

export const allTermKeys = Object.keys(glossary);