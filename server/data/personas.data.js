// server/data/personas.data.js
// Seed source for the `personas` table. One-click demo stories that pre-fill
// the recommender, served to the client from GET /api/personas.

export const personaSeed = [
  {
    id: "ravi-tailor",
    emoji: "🧵",
    label: {
